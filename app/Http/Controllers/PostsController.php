...
// !!!!!!!!!!!!!! Without elequent do this (example if you wanted to use SQL Queries instead of elequents built in function)
use DB;
...
class PostsController extends Controller
{
    ...
    {
        // $posts = Post::all();
        // $posts = Post::orderBy('title', 'desc')->get(); // <- Must call get() if adding clauses like orderBy
        // return $post = Post::where('title', 'Post Two')->get();
        // $posts = Post::orderBy('title', 'desc')->take(1)->get();

        // !!!!!!!!!!!!!! $posts = DB::select('SELECT * FROM posts'); <---- This is without elequent. See top where we said 'use DB'
